...
namespace std _GLIBCXX_VISIBILITY(default)
{
   ...
   */
	...
	{
	public:
		explicit _Sp_counted_ptr(_Ptr __p)
			: _M_ptr(__p) {}
	...
	public:
		...
		_M_destroy() noexcept
		{
			typedef typename allocator_traits<_Alloc>::template rebind_traits<_Sp_counted_deleter> _Alloc_traits;
	...
	public:
		...
		_M_destroy() noexcept
		{
			typedef typename allocator_traits<_Alloc>::template rebind_traits<_Sp_counted_ptr_inplace> _Alloc_traits;
	...
	public:
		...
		{
			__glibcxx_function_requires(_ConvertibleConcept<_Tp1 *, _Tp *>) auto __tmp = __r.get();
