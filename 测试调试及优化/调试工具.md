...
* 永久生效
    ...
    打开/etc/profile文件，增加如下以下并生使其生效ulimit -S -c unlimited > /dev/null 2>&1

    修改/etc/security/limits.conf文件，找到【* soft core 0】行，将其修改为如下内容：user soft core 1024或@group soft core 1024
